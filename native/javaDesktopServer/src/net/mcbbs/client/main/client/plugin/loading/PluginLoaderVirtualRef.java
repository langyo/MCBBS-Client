...
public class PluginLoaderVirtualRef extends PluginLoader {
    ...
    public PluginLoaderVirtualRef(PluginLoader loader) throws UnsupportedOperationException {
        if(loader==null||loader instanceof PluginLoaderVirtualRef||loader.getClass().isSynthetic())throw new UnsupportedOperationException("Cannot construct PluginLoaderVirtualRef with an unknown PluginLoader!");
    }
    @Override
