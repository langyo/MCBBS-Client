...
var _default = {
  "thread": {
    "urlReg": ["thread-([0-9]+)-([0-9]+)-1\\.html", "forum\\.php\\?mod=viewthread&tid=([0-9]+)&page=([0-9]+)(#pid([0-9]+))?"],
    "urlRegArgsIndex": [{
      "threadID": 1,
      "threadPageIndex": 2
    }, {
  ...
  "users": {
    "urlReg": ["home\\.php\\?mod=space&username=(.+)", "\\?([0-9]+)", "home.php\\?mod=space&uid=([0-9]+)"],
    "urlRegArgsIndex": [{
      "name": 1
    }, {
      "userID": 1
  ...
  "forum": {
    "urlReg": ["forum-([a-zA-Z0-9]+)-([0-9]+)\.html"],
    "urlRegArgsIndex": [{
      "forumID": 1,
      "forumPageIndex": 2
    }],
  ...
  "index-threads-list": {
    "urlReg": ["forum\.php\?mod=guide&view=({hot|digest|new|newthread})"],
    "urlRegArgsIndex": [{
      "type": 1
    }],
