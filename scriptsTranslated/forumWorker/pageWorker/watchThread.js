...
var _default = document => {
  ...
  if (document.querySelectorAll('#tath > a:nth-child(2)') > 0) {
    ...
    // 第一页时为查看量与回复量信息
    // 查看量
    thread.watchCount = document.querySelectorAll('#postlist > table:nth-child(1) > tbody > tr > td.pls.ptn.pbn > div > span:nth-child(2)')[0].innerHTML; // 回复量
